...
public class OpenKidoGrimoirePage extends SimpleInstantInteraction {

    public static final BuilderCodec<OpenKidoGrimoirePage> CODEC =
            BuilderCodec.builder(OpenKidoGrimoirePage.class, OpenKidoGrimoirePage::new, SimpleInteraction.CODEC)
                    .build();
