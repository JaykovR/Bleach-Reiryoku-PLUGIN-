...
public class OpenRaceSelectionPage extends SimpleInstantInteraction {

    public static final BuilderCodec<OpenRaceSelectionPage> CODEC =
            BuilderCodec.builder(OpenRaceSelectionPage.class, OpenRaceSelectionPage::new, SimpleInteraction.CODEC)
                    .build();
