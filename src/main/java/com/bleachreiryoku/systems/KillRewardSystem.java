...
public class KillRewardSystem extends DeathSystems.OnDeathSystem {
    ...
    private static final Map<String, Float> KILL_REWARDS = Map.ofEntries(
            Map.entry("Ghoul_Hollow_Small",        2.0f),
            Map.entry("Ghoul_Hollow",              3.0f),
            Map.entry("Ghoul_Hollow_Big",          4.0f),
            Map.entry("Scorpion_Hollow",           3.0f),
            Map.entry("Scorpion_Hollow_Big",       5.0f),
            Map.entry("Scarak_Louse_Hollow",       3.0f),
            Map.entry("Scarak_Fighter_Hollow",     3.0f),
            Map.entry("Scarak_Fighter_Hollow_Big", 5.0f),
            Map.entry("Scarak_Defender_Hollow",    5.0f),
            Map.entry("Crawler_Hollow_Small",      2.0f),
            Map.entry("Crawler_Hollow_Void",       3.0f),
            Map.entry("Crawler_Hollow_Big",       4.0f),
            Map.entry("Prangus_Hollow",            3.0f),
            // Vanilla Creatures
